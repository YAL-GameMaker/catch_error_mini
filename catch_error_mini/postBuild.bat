...
set extName=catch_error_mini
set dllName=catch_error_mini
set gmlDir14=%solutionDir%catch_error_mini.gmx
set gmlDir22=%solutionDir%catch_error_mini_yy
set gmlDir23=%solutionDir%catch_error_mini_23
